...
export default function SavePresetScreen({ navigation, route }) {
  ...
  async function saveAndGoBack(habitInfo) {
    ...
    setTimeout(async () => {
      await navigation.navigate('MainSwipeScreen', { habitInfo });
    }, 1000)
  };
  ...
  return (
    <View style={{ flex: 1, resizeMode: "cover", justifyContent: "center", backgroundColor: "black" }}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('MainSwipeScreen')} style={{position: "absolute", top: height * 0.065, zIndex: 100, padding: 15}}>
